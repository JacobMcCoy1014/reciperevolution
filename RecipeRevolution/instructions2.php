<?php   										
	...
	$ing1_1 = getIN($pdo, '0010');
	$ing1_2 = getIN($pdo, '0011');
	$ing1_3 = getIN($pdo, '0012');
	$ing1_4 = getIN($pdo, '0013');
	$ing1_5 = getIN($pdo, '0014');
	$ing1_6 = getIN($pdo, '0015');
	$ing1_7 = getIN($pdo, '0016');
	$ing1_8 = getIN($pdo, '0017');
	$ing1_9 = getIN($pdo, '0018');

	$inst1_1 = getInstructions($pdo, '0007');
	$inst1_2 = getInstructions($pdo, '0008');
	$inst1_3 = getInstructions($pdo, '0009');
	$inst1_4 = getInstructions($pdo, '0010');
	$inst1_5 = getInstructions($pdo, '0011');
		...
		<main>
			<div class="recipe-details-container">
				...
				<div class="recipe-details">
			        ...
			        <h1><?= 'Spaghetti Bolognese' ?></h1> <p> Difficulty:  <?= $info2['difficulty'] ?> </p>
					...
					<hr />
					<p>Prep Time:  <?= $info2['prep_time'] ?> minutes </p>
					<p>Cook Time:  <?= $info2['cook_time'] ?> minutes </p>
					<p>Total Time:  <?= $info2['total_time'] ?> minutes </p>
					<p>Servings:  <?= $info2['servings'] ?> </p>
