<?php   										
	...
	$ing1_1 = getIN($pdo, '0071');
	$ing1_2 = getIN($pdo, '0072');
	$ing1_3 = getIN($pdo, '0073');
	$ing1_4 = getIN($pdo, '0074');
	$ing1_5 = getIN($pdo, '0075');
	$ing1_6 = getIN($pdo, '0076');
	$ing1_7 = getIN($pdo, '0077');
	

	$inst1_1 = getInstructions($pdo, '0045');
	$inst1_2 = getInstructions($pdo, '0046');
	$inst1_3 = getInstructions($pdo, '0047');
	$inst1_4 = getInstructions($pdo, '0048');
	$inst1_5 = getInstructions($pdo, '0049');
		...
		<main>
			<div class="recipe-details-container">
				...
				<div class="recipe-details">
			        ...
			        <h1><?= 'Pasta Primavera' ?></h1> <p> Difficulty:  <?= $info9['difficulty'] ?> </p>
					...
					<hr />
					<p>Prep Time:  <?= $info9['prep_time'] ?> minutes </p>
					<p>Cook Time:  <?= $info9['cook_time'] ?> minutes </p>
					<p>Total Time:  <?= $info9['total_time'] ?> minutes </p>
					<p>Servings:  <?= $info9['servings'] ?> </p>
