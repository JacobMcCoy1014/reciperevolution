<?php   										
	...
	$ing1_1 = getIN($pdo, '0035');
	$ing1_2 = getIN($pdo, '0036');
	$ing1_3 = getIN($pdo, '0037');
	$ing1_4 = getIN($pdo, '0038');
	$ing1_5 = getIN($pdo, '0039');
	$ing1_6 = getIN($pdo, '0040');
	$ing1_7 = getIN($pdo, '0041');
	$ing1_8 = getIN($pdo, '0042');

	$inst1_1 = getInstructions($pdo, '0023');
	$inst1_2 = getInstructions($pdo, '0024');
	$inst1_3 = getInstructions($pdo, '0025');
	$inst1_4 = getInstructions($pdo, '0026');
	$inst1_5 = getInstructions($pdo, '0027');
	$inst1_6 = getInstructions($pdo, '0028');
		...
		<main>
			<div class="recipe-details-container">
				<div class="recipe-image">
					...
					<img src="imgs/bananabread.jpg" alt="A picture of Banana Bread">
				</div>

				<div class="recipe-details">

					<!-- Display name of Recipe and the difficulty -->
			        <h1><?= 'Banana Bread' ?></h1> <p> Difficulty:  <?= $info5['difficulty'] ?> </p>
					...
					<hr />
					<p>Prep Time:  <?= $info5['prep_time'] ?> minutes </p>
					<p>Cook Time:  <?= $info5['cook_time'] ?> minutes </p>
					<p>Total Time:  <?= $info5['total_time'] ?> minutes </p>
					<p>Servings:  <?= $info5['servings'] ?> </p>
