<?php   										
	...
	$ing1_1 = getIN($pdo, '0079');
	$ing1_2 = getIN($pdo, '0080');
	$ing1_3 = getIN($pdo, '0081');
	$ing1_4 = getIN($pdo, '0082');
	$ing1_5 = getIN($pdo, '0083');
	$ing1_6 = getIN($pdo, '0084');
	$ing1_7 = getIN($pdo, '0085');
	$ing1_8 = getIN($pdo, '0086');
	

	$inst1_1 = getInstructions($pdo, '0050');
	$inst1_2 = getInstructions($pdo, '0051');
	$inst1_3 = getInstructions($pdo, '0052');
	$inst1_4 = getInstructions($pdo, '0053');
	$inst1_5 = getInstructions($pdo, '0054');
	$inst1_6 = getInstructions($pdo, '0055');
		...
		<main>
			<div class="recipe-details-container">
				...
				<div class="recipe-details">
			        ...
			        <h1><?= 'Roast Turkey' ?></h1> <p> Difficulty:  <?= $info10['difficulty'] ?> </p>
					...
					<hr />
					<p>Prep Time:  <?= $info10['prep_time'] ?> minutes </p>
					<p>Cook Time:  <?= $info10['cook_time'] ?> minutes </p>
					<p>Total Time:  <?= $info10['total_time'] ?> minutes </p>
					<p>Servings:  <?= $info10['servings'] ?> </p>
