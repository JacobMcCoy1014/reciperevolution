<?php   										
	...
	$ing1_1 = getIN($pdo, '0030');
	$ing1_2 = getIN($pdo, '0031');
	$ing1_3 = getIN($pdo, '0032');
	$ing1_4 = getIN($pdo, '0033');
	

	$inst1_1 = getInstructions($pdo, '0018');
	$inst1_2 = getInstructions($pdo, '0019');
	$inst1_3 = getInstructions($pdo, '0020');
	$inst1_4 = getInstructions($pdo, '0021');
	$inst1_5 = getInstructions($pdo, '0022');
		...
		<main>
			<div class="recipe-details-container">
				<div class="recipe-image">
					...
					<img src="imgs/salad.jpg" alt="A picture of Chicken Noodle Soup">
				</div>

				<div class="recipe-details">

					<!-- Display name of Recipe and the difficulty -->
			        <h1><?= 'Caesar Salad' ?></h1> <p> Difficulty:  <?= $info4['difficulty'] ?> </p>
					...
					<hr />
					<p>Prep Time:  <?= $info4['prep_time'] ?> minutes </p>
					<p>Cook Time:  <?= $info4['cook_time'] ?> minutes </p>
					<p>Total Time:  <?= $info4['total_time'] ?> minutes </p>
					<p>Servings:  <?= $info4['servings'] ?> </p>
