<?php   										
	...
	$ing1_1 = getIN($pdo, '0001');
	$ing1_2 = getIN($pdo, '0002');
	$ing1_3 = getIN($pdo, '0003');
	$ing1_4 = getIN($pdo, '0004');
	$ing1_5 = getIN($pdo, '0005');
	$ing1_6 = getIN($pdo, '0006');
	$ing1_7 = getIN($pdo, '0007');

	$inst1_1 = getInstructions($pdo, '0001');
	$inst1_2 = getInstructions($pdo, '0002');
	$inst1_3 = getInstructions($pdo, '0003');
	$inst1_4 = getInstructions($pdo, '0004');
	$inst1_5 = getInstructions($pdo, '0005');
	$inst1_6 = getInstructions($pdo, '0006');
		...
		<main>
			<div class="recipe-details-container">
				...
				<div class="recipe-details">
			        ...
			        <h1><?= 'Homemade Guacamole' ?></h1> <p> Difficulty:  <?= $info1['difficulty'] ?> </p>
					...
					<hr />
					<p>Prep Time:  <?= $info1['prep_time'] ?> minutes </p>
					<p>Cook Time:  <?= $info1['cook_time'] ?> minutes </p>
					<p>Total Time:  <?= $info1['total_time'] ?> minutes </p>
					<p>Servings:  <?= $info1['servings'] ?> </p>
